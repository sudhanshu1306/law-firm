...
const [customStyleReference,changeCustomStyleReference]=useState({
 ...
 .then(function (res) {
  ...
  return (
    <div className="qweCard ">
      <div className="qweCard-header">
        <div className="cardHeader-title">
          <h3>{jobTitle}</h3>
        </div>
        <div className="companyLogo"> <img src={url} alt="company logo"/>  </div>
      </div>
      <p className="companyName">{companyName}</p>
      <p className="jobTypes">
        <span>Area of law: </span> {area.join()}
      </p>
      <p className="jobTypes">
        <span>Job Type: </span> {jobType.join()}
      </p>
      <div className="qweCard-details">
        <div className="qweSection">
          <div className="qwe-Section">
            <p>
              <EventIcon className="qweIcon" /> START DATE
            </p>
          </div>
          <p>Immediately</p>
        </div>
        <div className="qweSection">
          <div className="qwe-Section">
            <p>
              <LocationOnIcon className="qweIcon" /> LOCATION
            </p>
          </div>
          <p> {location}</p>
        </div>
        ...
        <div className="qweSection">
          <div className="qwe-Section">
            <p>
              <ScheduleIcon className="qweIcon" /> DURATION
            </p>
          </div>
          <p>3 Months</p>
        </div>
        <div className="qweSection">
          <div className="qwe-Section">
            <p>
              <EuroIcon className="qweIcon" /> STIPEND
            </p>
          </div>
          <p> {salaries} </p>
        </div>
      </div>
      <div className="areaOfLaw">
        {/* <p> {area.join()}</p>
        <p> {area.join()}</p>
        <p> {area.join()}</p> */}
      </div>
      <div className="qweCard-Bottom">
        <button onClick={handleOpen}>View Details</button>
        <button onClick={handleOpen1}>Apply now →</button>
      </div>
      <Modal
            ...
            <div className="jobCardContent1">
              ...
              <div className="name">
                <input
                  ...
                  defaultValue={defaultFields ? defaultFields.firstName : ""}
                />
                <input
                  type="text"
                  ...
                  name="lastName"
                  onChange={handleInput}
                  defaultValue={defaultFields ? defaultFields.lastName : ""}
                />
              </div>
              ...
              <textarea
                ...
                name="description"
                onChange={handleInput}
                defaultValue={defaultFields ? defaultFields.description : ""}
              />
              <div className="addskill">
                ...
                <MultiSelect
                  ...
                  options={options}
                  name="areaExperience"
                  defaultValue={defaultExperienced}
                />
              </div>
              <div className="addskill">
                ...
                <MultiSelect
                  ...
                  options={options}
                  name="areaInterested"
                  defaultValue={defaultInterested}
                />
              </div>
              <div className="addskill">
                <p>
                  ...
                  <span
                    ...
                    onClick={handleDisplayReference}
                  >
                    {" "}
                    Add new Reference{" "}
                  </span>
              ...
              <button className="newExpr" onClick={handleDisplay}>
                Add new Experience
              </button>
              <div className="addExperience" style={customStyle}>
                ...
                <button className="addexpe" onClick={handleExperience}>
                  {" "}
                  Add Experience
                </button>
              </div>
              <hr />
              <button className="addexpe" onClick={handleSubmit}>
                Apply
              </button>
            </div>
          </div>
